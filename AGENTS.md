...
JMo Security is a terminal-first security audit toolkit orchestrating 13 scanners with unified CLI, normalized outputs (CommonFinding schema v1.2.0), and HTML dashboard. Two-phase architecture: scan (invoke tools) → report (normalize, dedupe, output).
