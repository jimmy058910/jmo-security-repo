...
| [Profile Optimizer](jmo-profile-optimizer/SKILL.md) | `/jmo-profile-optimizer` | Tune per-tool timeouts, threads and flags from scan and report timings |
...
1. `/jmo-profile-optimizer` — Analyze scan and report timings, identify slow tools and parse bottlenecks
