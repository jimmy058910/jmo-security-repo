...
class TestPriorityCalculatorPerformance:
    ...
    def test_single_finding_calculation_latency(
        ...
        mock_epss_client.get_score.return_value = EPSSScore(
            cve="CVE-2024-1234", epss=0.85, percentile=0.95, date="2024-10-01"
        )
    ...
    @patch("scripts.core.priority_calculator.EPSSClient")
    @patch("scripts.core.priority_calculator.KEVClient")
    def test_bulk_calculation_latency(
        self, mock_kev_client_class, mock_epss_client_class
    ):
    ...
    @patch("scripts.core.priority_calculator.EPSSClient")
    @patch("scripts.core.priority_calculator.KEVClient")
    def test_cve_extraction_performance(
        self, mock_kev_client_class, mock_epss_client_class
    ):
