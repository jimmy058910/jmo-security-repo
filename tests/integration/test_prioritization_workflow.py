...
class TestPrioritizationWorkflow:
    ...
    def test_full_prioritization_workflow(self, mock_kev_client_class, mock_epss_client_class, temp_results_dir):
        ...
        kev_findings = [
            ...
            if f.get('priority', {}).get('is_kev', False)
        ]
    ...
    @patch('scripts.core.priority_calculator.EPSSClient')
    @patch('scripts.core.priority_calculator.KEVClient')
    def test_priority_in_markdown_summary(self, mock_kev_client_class, mock_epss_client_class):
    ...
    @patch('scripts.core.priority_calculator.EPSSClient')
    @patch('scripts.core.priority_calculator.KEVClient')
    def test_priority_in_html_dashboard(self, mock_kev_client_class, mock_epss_client_class, tmp_path):
        ...
        assert 'th data-key="priority"' in html_content or '<th data-key="priority">Priority</th>' in html_content
        ...
        assert 'if(sortKey===\'priority\')' in html_content or "sortKey==='priority'" in html_content
    ...
    @patch('scripts.core.priority_calculator.EPSSClient')
    @patch('scripts.core.priority_calculator.KEVClient')
    def test_enrichment_without_cves(self, mock_kev_client_class, mock_epss_client_class):
    ...
    @patch('scripts.core.priority_calculator.EPSSClient')
    @patch('scripts.core.priority_calculator.KEVClient')
    def test_bulk_priority_calculation_performance(self, mock_kev_client_class, mock_epss_client_class):
