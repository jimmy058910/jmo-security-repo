...
def test_write_simple_html_severity_colors(tmp_path):
    ...
    findings = [
        {"severity": "CRITICAL", "ruleId": "R1", "tool": {"name": "tool1"},
         "location": {"path": "a.js", "startLine": 1}, "message": "Critical issue"},
        {"severity": "HIGH", "ruleId": "R2", "tool": {"name": "tool2"},
         "location": {"path": "b.js", "startLine": 2}, "message": "High issue"},
        {"severity": "MEDIUM", "ruleId": "R3", "tool": {"name": "tool3"},
         "location": {"path": "c.js", "startLine": 3}, "message": "Medium issue"},
        {"severity": "LOW", "ruleId": "R4", "tool": {"name": "tool4"},
         "location": {"path": "d.js", "startLine": 4}, "message": "Low issue"},
        {"severity": "INFO", "ruleId": "R5", "tool": {"name": "tool5"},
         "location": {"path": "e.js", "startLine": 5}, "message": "Info issue"},
    ]
...
def test_write_simple_html_summary_stats(tmp_path):
    ...
    findings = [
        {"severity": "CRITICAL", "ruleId": "R1", "tool": {"name": "tool1"},
         "location": {"path": "a.js"}, "message": "Issue 1"},
        {"severity": "CRITICAL", "ruleId": "R2", "tool": {"name": "tool2"},
         "location": {"path": "b.js"}, "message": "Issue 2"},
        {"severity": "HIGH", "ruleId": "R3", "tool": {"name": "tool3"},
         "location": {"path": "c.js"}, "message": "Issue 3"},
    ]
...
def test_write_simple_html_email_client_compatibility(tmp_path):
    ...
    findings = [
        {"severity": "HIGH", "ruleId": "R1", "tool": {"name": "tool1"},
         "location": {"path": "a.js"}, "message": "Test"}
    ]
    ...
    assert 'href="http' not in html or 'href="https://jmotools.com"' in html  # Only footer link allowed
...
def test_write_simple_html_sorting_by_severity(tmp_path):
    ...
    findings = [
        {"severity": "INFO", "ruleId": "R5", "tool": {"name": "t1"},
         "location": {"path": "e.js"}, "message": "Info"},
        {"severity": "CRITICAL", "ruleId": "R1", "tool": {"name": "t2"},
         "location": {"path": "a.js"}, "message": "Critical"},
        {"severity": "MEDIUM", "ruleId": "R3", "tool": {"name": "t3"},
         "location": {"path": "c.js"}, "message": "Medium"},
        {"severity": "HIGH", "ruleId": "R2", "tool": {"name": "t4"},
         "location": {"path": "b.js"}, "message": "High"},
        {"severity": "LOW", "ruleId": "R4", "tool": {"name": "t5"},
         "location": {"path": "d.js"}, "message": "Low"},
    ]
...
def test_write_simple_html_tools_list(tmp_path):
    ...
    findings = [
        {"severity": "HIGH", "ruleId": "R1", "tool": {"name": "semgrep"},
         "location": {"path": "a.js"}, "message": "Test 1"},
        {"severity": "HIGH", "ruleId": "R2", "tool": {"name": "trivy"},
         "location": {"path": "b.js"}, "message": "Test 2"},
        {"severity": "HIGH", "ruleId": "R3", "tool": {"name": "bandit"},
         "location": {"path": "c.js"}, "message": "Test 3"},
    ]
