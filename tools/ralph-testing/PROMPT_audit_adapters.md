...
Audit the tool adapters and populate `tools/ralph-testing/IMPLEMENTATION_PLAN.md` with discovered issues:
...
Read `tools/ralph-testing/unified-state.json` and check `audits.adapters`:
